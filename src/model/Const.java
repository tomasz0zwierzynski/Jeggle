...
public final class Const {
	...
	public static final int ABSOLUTE_INITIAL_VELOCITY = 300;	//[px/ms]   default=30
	public static final double GRAVITY = 0.8;					//[px/ms2]  default=0.05
	public static final double BOUNCE_FACTOR = 0.85;			//[1]
